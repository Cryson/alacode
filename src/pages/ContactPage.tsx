...
export const ContactPage = () => {
  ...
  return (
    <Body label={label}>
      <PageTitle ref={pageTitleRef}>{fruitsData[4].image}お問い合わせフォーム</PageTitle>
      <ColorContainer page="contact" color={color.purpleMauve}>
        ...
        <Form ref={formRef} onSubmit={sendEmail}>
          ...
          <div className="row">
            ...
            <textarea id="formMessage" className="message" name="message" value={toSend.message} onChange={handleChange} required />
          </div>
          <ReCAPTCHA className="row -recaptcha" sitekey={process.env.REACT_APP_SITE_KEY as string} ref={recaptchaRef} onChange={recaptchaSuccess} />
