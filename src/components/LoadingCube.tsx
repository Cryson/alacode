...
export const LoadingFinish = createContext(false);

export const LoadingCube = ({ complete, setHoge }: {complete: Boolean, setHoge: React.Dispatch<React.SetStateAction<boolean>>}) => {
